...
Server to convert images to svg using the primitive algorithm.
...
```bash
git clone https://github.com/fromtheexchange/image2svg-primitive
cd image2svg-primitive
npm install
npm start:dev
```
...
- [http://localhost:4004/primitive/color](http://localhost:4002/primitive/color)
- [http://localhost:4004/primitive/black-and-white](http://localhost:4002/primitive/color)
...
- [primitive](https://www.npmjs.com/package/primitive) - Image tracing
...
This project is licensed as [MIT](LICENSE.md).
